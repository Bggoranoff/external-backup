package com.github.bggoranoff.model.files;
...
public class FileTest {
    private String getResourcePath(String fileName) {
        return Objects.requireNonNull(FileTest.class.getClassLoader().getResource("files")).getPath() + java.io.File.separator + fileName;
    }
